    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mb-12 px-8 gap-4">
        ...
        <div className="w-full lg:w-1/3">
          <input type="text" placeholder="Ej. Pátzcuaro" className="w-full px-5 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500 text-black"
          />
        </div>
        ...
        <div className="flex w-full lg:w-auto gap-2">
          ...
          <div className="relative w-full">
            ...
            <input type="date" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500 text-gray-700 bg-white" />
          </div>
        ...
        <div className="relative group w-full lg:w-auto">
            ...
            <button className="w-full lg:w-auto px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500 text-gray-700 bg-white flex items-center justify-center gap-2 hover:bg-gray-100">
            ...
            <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-300 rounded-lg shadow-xl hidden group-hover:block z-20 p-4">
              ...
              <div className="mb-4">
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-rose-500 text-gray-700 bg-white">
