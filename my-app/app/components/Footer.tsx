...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.5c2.07 0 3.984.627 5.565 1.697L19.5 4.5l-1.5 3a7.46 7.46 0 011.5 4.5c0 4.142-3.358 7.5-7.5 7.5S4.5 16.142 4.5 12 7.858 4.5 12 4.5zm0 3a4.5 4.5 0 100 9 4.5 4.5 0 000-9zm0 1.5a3 3 0 110 6 3 3 0 010-6z"/>
        </svg>
      ),
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <FadeCol delay={0} className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6"
              ...
              Un refugio de lujo frente al Lago de Pátzcuaro. Donde la tradición michoacana y el confort contemporáneo se encuentran.
            </p>
          ...
          <FadeCol delay={100}>
            ...
            <h4 className="text-xs uppercase tracking-[0.25em] font-semibold mt-8 mb-6"
              style={{ color: 'var(--copper)', fontFamily: 'var(--font-ui)' }}>
              Servicios
            </h4>
            <ul className="space-y-3">
              {['Reservaciones', 'Gastronomía'].map(s => (
                <li key={s}>
          ...
          <FadeCol delay={200}>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  label: 'Correo',
                  value: 'reservaciones@quintadalam.mx\ncontacto@quintadalam.mx'
                },
              ].map(item => (
            ...
            <div className="mt-7 p-4 rounded-lg" style={{ backgroundColor: 'rgba(245,240,232,0.05)', border: '1px solid rgba(245,240,232,0.1)' }}>
          ...
          <FadeCol delay={300}>
            <h4 className="text-xs uppercase tracking-[0.25em] font-semibold mb-3"
              style={{ color: 'var(--copper)', fontFamily: 'var(--font-ui)' }}>
              Newsletter
            </h4>
            <p className="text-sm leading-relaxed mb-5"
              style={{ fontFamily: 'var(--font-body)', color: 'rgba(245,240,232,0.55)', fontStyle: 'italic' }}>
              Recibe ofertas exclusivas, novedades del hotel y tips para tu próxima visita a Pátzcuaro.
            </p>
            {subscribed ? (
              <div className="p-4 text-center rounded-lg" style={{ backgroundColor: 'rgba(200,129,58,0.12)', border: '1px solid rgba(200,129,58,0.3)' }}>
                <p className="text-sm font-semibold" style={{ color: 'var(--copper)', fontFamily: 'var(--font-ui)' }}>¡Gracias por suscribirte! 🌿</p>
                <p className="text-xs mt-1" style={{ color: 'rgba(245,240,232,0.5)', fontFamily: 'var(--font-body)' }}>Pronto recibirás nuestras novedades.</p>
              </div>
            ) : (
              <form onSubmit={handleSubscribe} className="space-y-3">
                <input
                  ...
                  style={{ backgroundColor: 'rgba(245,240,232,0.07)', border: '1px solid rgba(245,240,232,0.15)', color: 'var(--cream)', fontFamily: 'var(--font-ui)' }}
                  onFocus={e => (e.target as HTMLElement).style.borderColor = 'var(--copper)'}
                  onBlur={e => (e.target as HTMLElement).style.borderColor = 'rgba(245,240,232,0.15)'}
                />
            ...
            <div className="mt-7 p-4 rounded-lg" style={{ backgroundColor: 'rgba(200,129,58,0.07)', border: '1px solid rgba(200,129,58,0.2)' }}>
