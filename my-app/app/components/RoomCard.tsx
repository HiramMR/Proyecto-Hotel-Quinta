...
//
// El botón "Reservar" ya NO navega a /rooms.
// Ahora llama a onReserve(room) para abrir el RoomModal
// desde el componente padre (rooms/page.tsx o HomeClient.tsx).
//
// Props nuevas:
//   onReserve — callback que recibe los datos de la habitación
// ============================================================
'use client';
