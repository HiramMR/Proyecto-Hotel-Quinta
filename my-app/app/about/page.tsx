// ============================================================
// about/page.tsx — Página "Nosotros" (Server Component)
// Sin 'use client' — renderizada en el servidor.
// No necesita interactividad, así que no requiere hooks.
//
// Estructura:
// 1. Hero: título sobre fondo oscuro con gradiente radial
// 2. Historia: texto + tarjetas de valores del hotel
// 3. Equipo: avatares del equipo directivo
// ============================================================
...
export default function AboutPage() {
  ...
  return (
    <main style={{ backgroundColor: 'var(--cream)', minHeight: '100vh' }}>
      ...
      {/* ══════════════════════════════════════════
          SECCIÓN 1: HERO
          Fondo oscuro (charcoal) con gradiente radial madera
          para dar calidez. El título tiene padding-top grande
          para compensar el NavBar fijo (pt-40).
          ══════════════════════════════════════════ */}
      <section
        className="relative flex items-end pb-16 pt-40 grain-overlay overflow-hidden"
        style={{ backgroundColor: 'var(--charcoal)' }}
      >
        {/* Gradiente radial sutil para añadir profundidad */}
      ...
      {/* ══════════════════════════════════════════
          ...
          - Izquierda: texto descriptivo del hotel
          - Derecha: tarjetas de valores numeradas
          ══════════════════════════════════════════ */}
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            {/* Tarjetas de valores — lista de 3 con número circular cobre */}
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-4 p-5"
                  ...
                  {/* Número del valor en círculo cobre */}
      ...
      {/* ══════════════════════════════════════════
          SECCIÓN 3: EQUIPO
          Fondo cream-dark para diferenciarse de la sección anterior.
          Avatares con inicial del nombre en fondo oscuro.
          ══════════════════════════════════════════ */}
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {team.map((member, i) => (
              <div key={i} className="text-center">
                {/* Avatar circular con inicial — se usaría una foto real en producción */}
